    ...
    const openLink = () => {
        Linking.openURL('');//link to website here will do that later
    };
    ...
    return (
        ...
        Clerk will need to verify your account. Carrier charges may apply.
            </Text>

            <View style={styles.list}>
            <View style={styles.listItem}>
                <Text style={styles.listItemText}>Ghana</Text>
            ...
            <MaskInput
                ...
                onChangeText={(masked: SetStateAction<string>, unmasked: any) => {
            ...
            to register. Learn how Clerk works with the{' '}
            <Text style={styles.link} onPress={openLink}>
                Clerk Companies
            </Text>
            .
